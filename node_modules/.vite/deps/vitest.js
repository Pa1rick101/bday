...
${indentationNext}`);
    ...
    function findPlugin(plugins5, val) {
      for (let p3 = 0; p3 < plugins5.length; p3++) {
        try {
          if (plugins5[p3].test(val)) {
            return plugins5[p3];
          }
        } catch (error) {
          throw new PrettyFormatPluginError(error.message, error.stack);
...
function resolveDeps(fixtures, depSet = /* @__PURE__ */ new Set(), pendingFixtures = []) {
  fixtures.forEach((fixture) => {
    ...
    if (depSet.has(fixture))
      throw new Error(`Circular fixture dependency detected: ${fixture.prop} <- ${[...depSet].reverse().map((d3) => d3.prop).join(" <- ")}`);
    depSet.add(fixture);
...
var L = !!globalThis.Netlify;
var A = !!globalThis.EdgeRuntime;
var _a4;
var D = ((_a4 = globalThis.navigator) == null ? void 0 : _a4.userAgent) === "Cloudflare-Workers";
var O = !!globalThis.Deno;
var S = !!globalThis.__lagon__;
var _a5, _b3;
var N = ((_b3 = (_a5 = globalThis.process) == null ? void 0 : _a5.release) == null ? void 0 : _b3.name) === "node";
var _a6, _b4;
var u = !!globalThis.Bun || !!((_b4 = (_a6 = globalThis.process) == null ? void 0 : _a6.versions) == null ? void 0 : _b4.bun);
var b = !!globalThis.fastly;
var G = [[L, "netlify"], [A, "edge-light"], [D, "workerd"], [O, "deno"], [S, "lagon"], [N, "node"], [u, "bun"], [b, "fastly"]];
function K() {
  const e = G.find((o) => o[0]);
  if (e)
    return { name: e[1] };
}
var g = K();
...
function T2(e) {
  ...
  p2(t2, "_isMockFunction", true), p2(t2, "length", e ? e.length : 0), p2(t2, "name", e && e.name || "spy");
  let n2 = v(t2);
...
function E2(e, t2, n2) {
  ...
  }, [r2, i] = a2(), o = P(e, r2), c2 = Object.getPrototypeOf(e), x = c2 && P(c2, r2), s2 = o || x;
  ...
  return p2(A2, "restore", K2), p2(A2, "getOriginal", () => l2 ? f() : f), p2(A2, "willCall", (w2) => (A2.impl = w2, S2)), O2(l2 ? () => S2 : S2), I2.add(S2), S2;
}
...
function parseStacktrace(stack, options = {}) {
  ...
  if (ignoreStackEntries.length)
    stacks = stacks.filter((stack2) => !ignoreStackEntries.some((p3) => stack2.file.match(p3)));
...
async function saveInlineSnapshots(environment, snapshots) {
  const MagicString = (await import("./magic-string.es-6LZ7NRIP.js")).default;
...
var MockDate = class _MockDate extends RealDate {
  constructor(y3, m3, d3, h2, M3, s2, ms) {
    super();
    let date;
    switch (arguments.length) {
      ...
      default:
        ...
        s2 = s2 || 0;
        ms = ms || 0;
        date = new RealDate(y3, m3, d3, h2, M3, s2, ms);
        break;
    }
...
var FakeTimers = class {
  ...
  useFakeTimers() {
    ...
    if (!this._fakingTime) {
      ...
      if (((_b5 = (_a8 = this._userConfig) == null ? void 0 : _a8.toFake) == null ? void 0 : _b5.includes("nextTick")) && globalThis.__vitest_worker__.isChildProcess)
